...
export const routes: Routes = [
  ...
  { path: 'unauthorized', loadComponent: () => import('./pages/unauthorized/unauthorized').then(m => m.Unauthorized) },
  {
    ...
    children: [
      ...
      { path: 'viagens', loadComponent: () => import('./pages/admin-viagens/admin-viagens').then(m => m.AdminViagens)},
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'buscar-viagens', loadComponent: () => import('./pages/search-trips/search-trips').then(m => m.SearchTripsComponent), canActivate: [authGuard] },
